...
#define CAR_STEER_GEOMETRY_CALIBRATED  (0)           // Set 1 only after measuring wheelbase and count-to-wheel-angle mapping.
...
#define CAR_LOCAL_DATUM_FIXED_ENABLE   (1)           // Isolated build variant: fixed field datum enabled.
#endif
#ifndef CAR_LOCAL_DATUM_FIXED_CONFIGURED
#define CAR_LOCAL_DATUM_FIXED_CONFIGURED (1)         // Isolated build variant: surveyed coordinates configured.
#endif
#ifndef CAR_LOCAL_DATUM_FIXED_LAT_DEG
#define CAR_LOCAL_DATUM_FIXED_LAT_DEG  (31.0)        // Compile-only isolated build coordinate.
#endif
#ifndef CAR_LOCAL_DATUM_FIXED_LON_DEG
#define CAR_LOCAL_DATUM_FIXED_LON_DEG  (117.0)
#endif
...
#define CAR_GPS_ANTENNA_FORWARD_M      (0.0f)        // Measure from rear-axle reference; positive forward.
#define CAR_GPS_ANTENNA_LEFT_M         (0.0f)        // Positive to vehicle left.
